...
//			}
	...
	private function get_loadlist($user_id,$where) {
    	...
    	$sql = "select dlr.*,u.user_name,u.level_id,u.province_id,u.city_id from ".DB_PREFIX."deal_load_repay dlr LEFT JOIN ".DB_PREFIX."user u ON u.id=dlr.user_id where  dlr.user_id = ".$user_id." $condtion order by dlr.repay_time desc ";

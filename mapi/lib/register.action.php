...
class register{
	public function index()
	{
		...
		$mobile = strim($GLOBALS['request']['phone']);
		$mobile_code = strim($GLOBALS['request']['mobile_code']);
	
		$root['aaaaaaaaaaaa']= $user_name;
		$root['bbbbbbbb']= $user_pwd;
		$root['ccccccc']= $user_pwd_confirm;
		$root['dddddddddddd']= $mobile;
		$root['eeeeeeeee']= $mobile_code;

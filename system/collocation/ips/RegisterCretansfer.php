<?php
	...
	function RegisterCretansfer($transfer_id,$t_user_id, $MerCode,$cert_md5,$post_url){
		...
		$pWebUrl= SITE_DOMAIN.APP_ROOT."/index.php?ctl=collocation&act=response&class_name=Ips&class_act=RegisterCretansfer";//web方式返回
		$pS2SUrl= SITE_DOMAIN.APP_ROOT."/index.php?ctl=collocation&act=notify&class_name=Ips&class_act=RegisterCretansfer";//s2s方式返回		

<?php
	...
	function RegisterCreditor($user_id,$deal_id,$pAuthAmt,$MerCode,$cert_md5,$post_url){
		...
		$pWebUrl= SITE_DOMAIN.APP_ROOT."/index.php?ctl=collocation&act=response&class_name=Ips&class_act=RegisterCreditor";//web方式返回
		$pS2SUrl= SITE_DOMAIN.APP_ROOT."/index.php?ctl=collocation&act=notify&class_name=Ips&class_act=RegisterCreditor";//s2s方式返回		

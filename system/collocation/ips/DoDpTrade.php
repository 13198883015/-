<?php
	...
	function DoDpTrade($user_id,$user_type,$pTrdAmt,$pTrdBnkCode,$MerCode,$cert_md5,$post_url){
		...
		$pWebUrl= SITE_DOMAIN.APP_ROOT."/index.php?ctl=collocation&act=response&class_name=Ips&class_act=DoDpTrade";//web方式返回
		$pS2SUrl= SITE_DOMAIN.APP_ROOT."/index.php?ctl=collocation&act=notify&class_name=Ips&class_act=DoDpTrade";//s2s方式返回		
		...
		$data['pIpsFeeType'] = 2;//'谁付IPS手续费 否 这里是IPS向平台收取的费用 1：平台支付 2：用户支付 ',

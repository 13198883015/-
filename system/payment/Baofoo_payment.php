...
class Baofoo_payment implements payment {
	...
	public function get_payment_code($payment_notice_id) {
        ...
        $def_url = '<form style="text-align:center;" action="'.SITE_DOMAIN.APP_ROOT."/baofoo_post.php".'" target="_blank" style="margin:0px;padding:0px" method="POST" >';
    ...
    public function get_display_code() {
		...
		if($payment_item)
		{
	        ...
	        $html .=".bk_type_0{background:url(".SITE_DOMAIN.APP_ROOT."/system/payment/Baofoo/baofoo.jpg) no-repeat right center; font-size:0px; width:150px; height:10px;}"; 
	        $html .="</style>";

<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:40:"D:/data/WWW/app/Tpl/blue/page/deals.html";i:1;s:40:"D:/data/WWW/app/Tpl/blue/inc/header.html";i:2;s:40:"D:/data/WWW/app/Tpl/blue/inc/footer.html";}s:7:"expires";i:1498465199;s:8:"maketime";i:1498465139;}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta name="Generator" />
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>信用认证标 - 我要理财 - p2p信贷</title>
		...
		<div class="short filterbox">
			<div class="bddf clearfix" id="deallist" name="deallist">
				...
				<div class="propAttrs clearfix pr " id="search_condition" style="height:130px">
		            ...
		            <form action="/index.php?ctl=deals&cid=1" method="post" id="searchByConditionForm">
		                    ...
		                    <div class="attrValues">
								<ul class="av-collapse" id="dashboard">
										...
										<a href="/index.php?ctl=deals#deallist" >不限</a>
																		...
																		<li >
										<a href="/index.php?ctl=deals&cid=1#deallist" class="cur">信用认证标</a>
									</li>
																		<li >
						...
						<div class="attr">
							...
							<div class="attrValues">
								<ul class="av-collapse" name="interest" id="months">
											                            <li><a href="/index.php?ctl=deals&cid=1#deallist" class="cur">不限</a></li>
											                            <li><a href="/index.php?ctl=deals&cid=1&months_type=1#deallist" >3 个月以下</a></li>
											                            <li><a href="/index.php?ctl=deals&cid=1&months_type=2#deallist" >3-6 个月</a></li>
											                            <li><a href="/index.php?ctl=deals&cid=1&months_type=3#deallist" >6-9 个月</a></li>
											                            <li><a href="/index.php?ctl=deals&cid=1&months_type=4#deallist" >9-12 个月</a></li>
											                            <li><a href="/index.php?ctl=deals&cid=1&months_type=5#deallist" >12 个月以上</a></li>
											                        </ul>
		                    </div>
		                </div>
						<div class="attr">
		                    ...
		                    <div class="attrValues">
								<ul class="av-collapse" id="dashboard">
																		<li >
										<a href="/index.php?ctl=deals&cid=1#deallist" class="cur">不限</a>
									</li>
																		<li >
										<a href="/index.php?ctl=deals&cid=1&deal_status=1#deallist" >进行中</a>
									</li>
																		<li >
										<a href="/index.php?ctl=deals&cid=1&deal_status=2#deallist" >满标</a>
									</li>
																		<li >
										<a href="/index.php?ctl=deals&cid=1&deal_status=3#deallist" >流标</a>
									</li>
																		<li >
										<a href="/index.php?ctl=deals&cid=1&deal_status=4#deallist" >还款中</a>
									</li>
																		<li >
										<a href="/index.php?ctl=deals&cid=1&deal_status=5#deallist" >已还清</a>
									</li>
		                    ...
		                    <div class="attrValues">
								<ul class="av-collapse" name="level" id="level">
									   ...
									   <a href="/index.php?ctl=deals&cid=1#deallist" class="cur">不限</a>
								   								   ...
								   								   <li>
									   <a href="/index.php?ctl=deals&cid=1&level=7#deallist" >AA以上</a>
								   </li>
								   								   <li>
									   <a href="/index.php?ctl=deals&cid=1&level=6#deallist" >A以上</a>
								   </li>
								   								   <li>
									   <a href="/index.php?ctl=deals&cid=1&level=5#deallist" >B以上</a>
								   </li>
								   								   <li>
									   <a href="/index.php?ctl=deals&cid=1&level=4#deallist" >C以上</a>
								   </li>
								   								   <li>
									   <a href="/index.php?ctl=deals&cid=1&level=3#deallist" >D以上</a>
								   </li>
								   								   <li>
									   <a href="/index.php?ctl=deals&cid=1&level=2#deallist" >E以上</a>
								   </li>
								   								   <li>
									   <a href="/index.php?ctl=deals&cid=1&level=1#deallist" >HR以上</a>
								   </li>
								   								</ul>
							</div>
		                </div>
		                    ...
		                    <div class="attrValues">
								<ul class="av-collapse" name="interest" id="interest">
									   ...
									   <a href="/index.php?ctl=deals&cid=1#deallist" class="cur">不限</a>
								   								   ...
								   								   <li>
									   <a href="/index.php?ctl=deals&cid=1&interest=10#deallist" >10%以上</a>
								   </li>
								   								   <li>
									   <a href="/index.php?ctl=deals&cid=1&interest=12#deallist" >12%以上</a>
								   </li>
								   								   <li>
									   <a href="/index.php?ctl=deals&cid=1&interest=15#deallist" >15%以上</a>
								   </li>
								   								   <li>
									   <a href="/index.php?ctl=deals&cid=1&interest=18#deallist" >18以上</a>
								   </li>
								   		                        </ul>
		                    </div>
		                </div>
		                    ...
		                    <div class="attrValues">
								<ul class="av-collapse" name="lefttime" id="lefttime">
									   ...
									   <a href="/index.php?ctl=deals&cid=1#deallist" class="cur">不限</a>
								   								   ...
								   								   <li>
									   <a href="/index.php?ctl=deals&cid=1&lefttime=1#deallist" >1天以内</a>
								   </li>
								   								   <li>
									   <a href="/index.php?ctl=deals&cid=1&lefttime=3#deallist" >3天以内</a>
								   </li>
								   								   <li>
									   <a href="/index.php?ctl=deals&cid=1&lefttime=6#deallist" >6天以内</a>
								   </li>
								   								   <li>
									   <a href="/index.php?ctl=deals&cid=1&lefttime=9#deallist" >9天以内</a>
								   </li>
								   								   <li>
									   <a href="/index.php?ctl=deals&cid=1&lefttime=12#deallist" >12天以内</a>
								   </li>
								   		                        </ul>
		                    </div>
		                </div>

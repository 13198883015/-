						...
						<div class="attr">
		                    ...
		                    <div class="attrValues">
								<ul class="av-collapse" id="dashboard">
									<?php $_from = $this->_var['cate_list_url']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'cates_0_44441000_1498463806');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['cates_0_44441000_1498463806']):
?>
									<li >
										<a href="<?php echo $this->_var['cates_0_44441000_1498463806']['url']; ?>#deallist" <?php if ($this->_var['cates_0_44441000_1498463806']['id'] == $this->_var['cate_id']): ?>class="cur"<?php endif; ?>><?php echo $this->_var['cates_0_44441000_1498463806']['name']; ?></a>
									</li>
						...
						<div class="attr">
							...
							<div class="attrValues">
								<ul class="av-collapse" name="interest" id="months">
									<?php $_from = $this->_var['months_type_url']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'months_0_44549200_1498463806');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['months_0_44549200_1498463806']):
?>
		                            <li><a href="<?php echo $this->_var['months_0_44549200_1498463806']['url']; ?>#deallist" <?php if ($this->_var['key'] == $this->_var['months_type']): ?>class="cur"<?php endif; ?>><?php echo $this->_var['months_0_44549200_1498463806']['name']; ?></a></li>
									<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
		                        </ul>
		                    </div>
		                </div>

...
?>" name="page_login_form" id="page_login_form">
								<div class="field username pr">
									...
									<span class="holder_tip ps"><?php echo $this->_var['LANG']['USER_TITLE_EMAIL']; ?>/<?php echo $this->_var['LANG']['USER_TITLE_USER_NAME']; ?>/<?php echo $this->_var['LANG']['MOBILE']; ?></span>
								...
								<div class="field verify">
									...
									<img class="ml10 f_l" maxlength="4" style="margin-top:0" src="<?php echo $this->_var['APP_ROOT']; ?>/verify.php?w=89&h=44&rand=<?php 
$k = array (
  'name' => 'rand',
);
echo $k['name']();
?>" onclick="this.src='<?php echo $this->_var['APP_ROOT']; ?>/verify.php?w=89&h=44&rand='+ Math.random();" id="Jverify_img" title="看不清楚？换一张" />			
								...
								<?php endif; ?>
								<div class="field autologin clearfix" style="font-size:12px;<?php if (app_conf ( "VERIFY_IMAGE" ) != 1): ?>padding-bottom:20px;<?php endif; ?>">
									<div  class="f_l f_yahei f14" style="color:#8c8c8c">
										<span class="ui-select">
											<input type="checkbox" id="autologin" name="auto_login" value="1" tabindex="3" >
										</span>
										<?php echo $this->_var['LANG']['AUTO_LOGIN']; ?>
									</div>									
									<div class="lostpassword f_r">
									<a href="<?php
echo parse_url_tag("u:index|user#getpassword|"."".""); 
?>" class="f14 lh26 f_blue"><?php echo $this->_var['LANG']['FORGET_PASSWORD']; ?></a>
									</div>
								</div>
